...
# To bisect a givin finite straight line.
...
# Bisecting the straight line.

pygame.draw.line(screen, (0, 0, 0), (Math.avg(a[0], b[0]), a[1]), (Math.avg(a[0], b[0]), a[1] - Math.pythagac(dist/2, dist)), 2)
pygame.display.flip()
